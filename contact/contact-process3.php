...
$error = false;
$fields = array('text','number','email','subject','messagewr' );
...
if ( !$error ) {
	...
	$email = stripslashes($_POST['text']);
	$phone = stripslashes($_POST['number']);	
	$email = stripslashes($_POST['email']);
    $email = stripslashes($_POST['subject']);
	$phone = stripslashes($_POST['messagewr']);	
